    ...
    <section id="about" className="about-section">
      <div className="container about-content">
        ...
        <div className="about-text">
          <h2>Sobre a Dra. Micheline Menezes</h2>
          <p>
            Com anos de experiência e uma busca incessante por excelência, a Dra. Micheline Menezes oferece um atendimento humanizado e focado em resultados. Acreditamos que a odontologia é a arte de transformar vidas, devolvendo a confiança e a alegria de sorrir.
          </p>
          <p>
